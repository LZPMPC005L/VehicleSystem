...
from vehicle.views import register_owner,register_vehicle, license_plate_recognition_record, create_violation
...
urlpatterns = [
    ...
    path("create_violation/", create_violation, name="create_violation"),
]
